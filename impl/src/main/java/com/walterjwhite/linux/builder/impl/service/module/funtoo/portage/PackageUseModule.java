...
public class PackageUseModule extends AbstractPortagePackageModule {
  @Inject
  public PackageUseModule(
      BuildService buildService,
      BuildConfiguration buildConfiguration,
      DistributionConfiguration distributionConfiguration) {
    super(
        buildService, buildConfiguration, distributionConfiguration, PortageConfigurationType.Use);
  }
}
